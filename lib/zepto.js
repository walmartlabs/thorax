...
;(function($){
  ...
  $(document).ready(function(){
    ...
    $(document.body).bind('touchstart', function(e){
      ...
      // UPGRADE WARN:
      // Library modification here to prevent funky behavior. Pull request pushed
      // upstream at https://github.com/madrobby/zepto/pull/553
      ...
      // normal tap
        ...
        touchTimeout = setTimeout(function(){
          touchTimeout = null
          // UPGRADE WARN:
          // Library modification here to prevent NPE in logs (no direct user impact). Pull request
          // pushed upstream at https://github.com/madrobby/zepto/pull/554
